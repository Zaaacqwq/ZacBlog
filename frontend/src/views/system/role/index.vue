<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="Role Name" prop="roleName" :show-overflow-tooltip="true" width="200" />
      <el-table-column label="Permission Key" prop="roleKey" :show-overflow-tooltip="true" width="150" />
      <el-table-column label="Display ID" prop="roleSort" width="100" />
...
export default {
  ...
  data() {
    return {
      ...
      dataScopeOptions: [
        ...
        {
          value: "3",
          label: "Department-only data permissions"
        },
        {
          value: "4",
        ...
        {
          value: "5",
          label: "Personal-only data permissions"
        }
      ],
      // 菜单列表
      menuOptions: [],
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('Are you sure you want to "' + text + '" role "' + row.roleName + '"?').then(function() {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('Are you sure you want to delete the role with ID "' + roleIds + '"?').then(function() {
